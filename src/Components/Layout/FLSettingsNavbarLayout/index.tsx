...
import { IFLSettingsNavbarLayoutProps } from "./FLSettingNavbarLayout.interface";
...
export const FLSettingsNavbarLayout = memo(
  (props: IFLSettingsNavbarLayoutProps) => {
    const {
      testID,
      handleLogOut,
      headbarPosition,
                ...
                >
                  <ListItemIcon sx={{ minWidth: 0, mr: "10px" }}>
                    <SettingsOutlinedIcon
                      color={
                        initialPath === "/settings" ? "primary" : "inherit"
                      }
                    />
                  </ListItemIcon>
                  <ListItemText>
